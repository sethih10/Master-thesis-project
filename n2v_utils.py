...
def plot_corruption(noisy, 
    ...
    axs[0].imshow(noisy, cmap = 'viridis') #, cmap=seismic_cmap, vmin=vmin, vmax=vmax)
    axs[1].imshow(crpt, cmap = 'viridis') #cmap=seismic_cmap, vmin=vmin, vmax=vmax)
...
def plot_synth_results(clean, 
    ...
    axs[0].imshow(clean, aspect='auto', cmap='viridis')
    axs[1].imshow(noisy, aspect='auto', cmap='viridis')
    axs[2].imshow(denoised, aspect='auto', cmap='viridis')
    axs[3].imshow(noisy-denoised, aspect='auto', cmap='viridis')
...
def plot_field_results(noisy, 
    ...
    axs[0].imshow(noisy, aspect='auto', cmap='viridis')
    axs[1].imshow(denoised, aspect='auto', cmap='viridis')
